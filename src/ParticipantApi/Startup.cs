...
using ParticipantApi.Behaviours;
using ParticipantApi.Common;
using ParticipantApi.DependencyRegistrations;
using ParticipantApi.Extensions;
using ParticipantApi.HealthChecks;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                {
                    c.SwaggerDoc(description.GroupName, new OpenApiInfo { Title = "Dte.Participant.Api", Version = description.GroupName });
                }
                
                var filePath = Path.Combine(AppContext.BaseDirectory, "ParticipantApi.xml");
            ...
            services.AddHealthChecks()
                .AddCheck("ParticipantService", () => HealthCheckResult.Healthy($"Build: {build}"))
        ...
        public void Configure(IApplicationBuilder app, IApiVersionDescriptionProvider provider)
        {
            ...
            app
                ...
                .UseEndpoints(endpoints =>
                {
                    ...
                    endpoints.MapGet("/", async context => { await context.Response.WriteAsync("Participant API V0.0.1"); });
                });
        }
    }
}